<?php $this->load->view('theme/header_com'); ?>
                ...
                </form><a class="btn btn-light action-button" role="button" href="#" style="margin-top: 2px;background: var(--gray);font-size: 12px;border-radius: 4px;border-top-right-radius: 4px;border-bottom-right-radius: 4px;"><i class="fa fa-print" style="font-size: 14px;"></i></a>
            </div>
        </div>
    </nav>
                ...
                <table class="table">
                    <thead>
                        <tr style="color: var(--gray);">
                            ...
                            <th style="width: 105px;height: 44px;">En attente</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Cell 2</td>
                            <td>Cell 2</td>
                            <td style="font-size: 12px;width: 30px;"><button class="btn btn-light" type="button" style="background: rgb(153,217,168);margin-right: 0px;height: 34px;margin-top: -7px;padding-top: 1px;border-radius: 4px;font-size: 12px;"><i class="fa fa-pencil-square-o" style="font-size: 12px;padding-top: 0px;"></i> parrainer</button></td>
                        </tr>
                        <tr></tr>
                    </tbody>
                </table>
