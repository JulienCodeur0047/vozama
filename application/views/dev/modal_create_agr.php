                    ...
                    <div class="form-row">
                        <div class="col">
                            <div class="form-row">
                                ...
                                <div class="col"><label style="font-size: 10px;color: var(--gray);height: 10px;margin-bottom: 0px;">Quantité</label><input type="text" class="form-control" style="font-size: 12px;margin-left: -1px;margin-right: 0px;width: 239px;height: 30px;padding-top: 4px;margin-bottom: 3px;" placeholder="123" name="agr_qte" inputmode="numeric" /><label style="font-size: 10px;color: var(--gray);height: 10px;margin-bottom: 0px;">Unité</label><select class="form-control" style="width: 238px;height: 30px;font-size: 12px;color: var(--gray);" name="agr_unite">
                                    ...
                                    <select class="form-control" style="width: 238px;height: 30px;font-size: 12px;color: var(--gray);" name="parent_id">
                                        <optgroup label="Unite">
                                    ...
                                    <label style="font-size: 10px;color: var(--gray);height: 10px;margin-bottom: 0px;">Formation</label><input type="text" class="form-control" style="font-size: 12px;margin-left: -1px;margin-right: 0px;width: 239px;height: 30px;padding-top: 4px;margin-bottom: 3px;" placeholder="Formation" name="agr_formation" /></div>
                            </div>
                        </div>
