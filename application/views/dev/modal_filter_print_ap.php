<div role="dialog" id="apfilterprint" tabindex="-1" class="modal fade show" >
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open('printap'); ?>
            <form method="POST" >
                <div class="row" style="height: auto;width: auto;">
                    <div class="col" style="height: auto;"><label style="margin-bottom: -4px;font-size: 11px;">Poste</label>
                    <select name="postefilter" style="font-size: 12px;width: 250px;color: var(--gray);height: 25px;border-radius: 2px;">
                        ...
                        </select><label style="margin-bottom: -4px;font-size: 11px;">Année </label>
                        <select name="anneefilter" style="font-size: 12px;width: 250px;color: var(--gray);height: 25px;border-radius: 2px;">
                            <optgroup label="Poste">
