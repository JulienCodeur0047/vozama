        ...
        <div class="modal-content">
            ...
            <?php echo form_open('updateagr') ?>
                <form style="height: auto;" method="POST">
                    ...
                    </div><input type="text" class="form-control id invisible" style="font-size: 12px;margin-left: 83px;margin-right: 54px;width: 300px;height: 30px;padding-top: 4px;margin-bottom: 3px;" placeholder="Poste" />
