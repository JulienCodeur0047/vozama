<div role="dialog" id="newaep" tabindex="-1" class="modal fade show">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: auto;">
                <div class="row" style="height: auto;width: auto;">
                    <div class="col" style="width: 303px;height: auto;"><label style="margin-bottom: -4px;font-size: 11px;">Date</label><input type="date" style="width: 216px;font-size: 13px;color: var(--gray);" name="aep_date" /><label style="margin-bottom: -4px;font-size: 11px;">Nom du Parrain</label><input type="text" style="width: 216px;font-size: 13px;height: 25px;" name="aep_parrain" /></div>
