<?php $this->load->view('theme/header_tour'); ?>
    ...
    <div class="card" style="border-radius: 0px;margin-bottom: 22px;border-width: 0px;">
        <div class="card-body" style="margin-top: 0px;margin-bottom: 3px;">
            <h1 style="margin-bottom: 18px;height: 16px;font-size: 15px;color: var(--gray);">Logement de touriste</h1>
            <div class="table-responsive" style="width: auto;font-size: 12px;">
                <table class="table">
                    <thead>
                        <tr style="color: var(--gray);">
                            <th style="width: 144px;">Nom et Prénoms Touriste</th>
                            <th style="width: 15px;height: 44px;">Logement Num</th>
