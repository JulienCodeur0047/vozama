<section style="background: var(--white); ">
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-search" style="margin-top: -8px;margin-bottom: 28px;height: 49px;">
        <div class="container"><a class="navbar-brand" href="#" style="margin-top: 9px;font-size: 14px;color: var(--gray);">Alphabétisation</a><button data-toggle="collapse" data-target="#navcol-1" class="navbar-toggler"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1" style="margin-top: 9px;">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link" href="#" style="border-right-width: 2px;border-right-color: rgb(102,102,102);font-size: 13px;width: 235.344px;padding-right: 0px;padding-left: 33px;">Détail de la visite de poste numéro</a></li>
				...
				<a class="btn btn-light action-button" role="button" href="#" style="margin-top: 2px;background: var(--green);font-size: 12px;margin-left: 0px;border-radius: 0px;"><i class="fa fa-edit" style="font-size: 14px;"></i></a>
				...
				<a class="btn btn-light action-button" role="button" href="#" style="margin-top: 2px;background: var(--gray);font-size: 12px;margin-left: 0px;border-radius: 0px;"><i class="fa fa-print" style="font-size: 14px;"></i></a>
            </div>
        </div>
    </nav>
	...
	<fieldset disabled="disabled">
        <div class="form-row">
            <div class="col-xl-5" style="padding-left: 4px;padding-right: 8px;"><label style="font-size: 10px;margin-bottom: 0px;margin-left: 4px;">Poste</label><label style="font-size: 12px;margin-bottom: 0px;margin-left: 4px;color: var(--red);">*</label><select class="form-control" style="font-size: 12px;" name="vp_poste">
                    <optgroup label="Poste">
                        <option value selected><?php echo $vp->vp_poste?></option>
                    </optgroup>
                </select>
                <div>
                ...
                <div class="form-row">
                    <div class="col"><label style="font-size: 10px;margin-bottom: 0px;margin-left: 4px;">Moniteur</label><select class="form-control" style="font-size: 12px;" name="vp_moniteur">
                            <optgroup label="Moniteur">
                                <option value selected><?php echo $vp->vp_moniteur?></option>
                            </optgroup>
                        </select></div>
            ...
            <div class="col" style="padding-left: 14px; margin-bottom: 10px">
                <div class="form-check"><input type="checkbox" class="form-check-input" id="formCheck-1" <?php echo ($vp->vp_presence_moniteur=="oui" ? 'checked' : '');?> /><label class="form-check-label" for="formCheck-1" style="font-size: 12px;">Présence moniteur </label></div>
                <div class="form-row" style="margin-bottom: -1px;">
                    ...
                    <div class="col-xl-6"><label style="font-size: 10px;margin-bottom: 0px;margin-left: 4px;">Raison du remplacement</label><input type="text" class="form-control" style="font-size: 12px;" name="vp_rempl_raison" />
                        <div class="form-check"><input type="checkbox" class="form-check-input" id="formCheck-2" <?php echo ($vp->vp_cahier_appel=="oui" ? 'checked' : '');?>/><label class="form-check-label" for="formCheck-1" style="font-size: 12px;">Cahier d&#39;appel à jour</label></div><label style="font-size: 10px;margin-bottom: 0px;margin-left: 4px;">Remarque</label><input type="text" class="form-control" style="font-size: 12px;" name="vp_rem_cahier_appel" />
                    </div>
                </div>
                <div class="form-check"><input type="checkbox" class="form-check-input" id="formCheck-1" <?php echo ($vp->vp_appel_fait=="oui" ? 'checked' : '');?>/><label class="form-check-label" for="formCheck-1" style="font-size: 12px;">L&#39;appel fait</label></div>
                <div class="form-row">
